...
object Trap {
  ...
  case object AgonyMask extends TrapSkeleton(45, 0.9, Ceiling, Sadistic, 95, Set(Move2))
  ...
  case object Cakeintheface extends TrapSkeleton(1, 2.0, Wall, Humiliating, 95, Set(Projectile, Move4))
  ...
  case object DeltaHorseRodeo extends TrapSkeleton(35, 0.5, Floor, Humiliating, 90, Set(MoveToWall))
  case object EvilPunch extends TrapSkeleton(20, 1.0, Floor, Elaborate, 66, Set(MoveToWall))
  case object EvilStomp extends TrapSkeleton(50, 1.0, Floor, Humiliating, 66, Set(HitsNear))
  case object EvilStrike extends TrapSkeleton(35, 0.8, Floor, Elaborate, 66, Set(Move2))
  case object Fireball extends TrapSkeleton(35, 1.8, Wall, Elaborate, 85, Set(Projectile))
  ...
  case object FrozenArrow extends TrapSkeleton(20, 2.0, Wall, Elaborate, 75, Set(Projectile, Freeze))
  case object GatlingArrow extends TrapSkeleton(12, 1.0, Wall, Sadistic, 55, Set(Projectile, StageHit7))
  ...
  case object IronBall extends TrapSkeleton(60, 0.8, Ceiling, Elaborate, 80, Set(Roll))
  case object IronRake extends TrapSkeleton(10, 0.7, Floor, Humiliating, 75, Set(Move1, Enrage))
  ...
  case object LightningSpear extends TrapSkeleton(45, 1.4, Wall, Elaborate, 95, Set(Projectile))
  ...
  case object RollingBomb extends TrapSkeleton(55, 1.2, Wall, Elaborate, 100, Set(Roll))
  ...
  case object Snowball extends TrapSkeleton(20, 1.1, Ceiling, Humiliating, 55, Set(Roll))
  ...
  case object SpikedBall extends TrapSkeleton(70, 0.7, Ceiling, Sadistic, 90, Set(Roll, MoveToWall))
  ...
  case object WallSmash extends TrapSkeleton(15, 1.4, Wall, Elaborate, 70, Set(MoveToWall))
  case object Washbin extends TrapSkeleton(7, 2.4, Ceiling, Humiliating, 90, Set(Move1, Enrage))
