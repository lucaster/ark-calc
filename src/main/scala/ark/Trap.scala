...
object Trap {
  ...
  val ReapersScythe = Trap("Reaper's Scythe", 50, 0.9, Wall, Sadistic, 70, Set(Move2))
  val RodeoHorseJet = Trap("Rodeo Horse Jet", 45, 0.4, Floor, Sadistic, 90, Set(MoveToWall))
  val RollingBomb = Trap("Rolling Bomb", 55, 1.2, Wall, Elaborate, 100, Set(Roll, Move2, Fire))
  val ScreamFace = Trap("Scream Face", 5, 1.9, Ceiling, Humiliating, 60, Set(Move3))
  val SharkBlade = Trap("Shark Blade", 25, 1.0, Floor, Sadistic, 50)
  ...
  val SparkRod = Trap("Spark Rod", 35, 0.6, Floor, Elaborate, 60, Set(Bind, Electric))
  val Spatula = Trap("Spatula", 15, 1.2, Wall, Elaborate, 60, Set(StageHit2))
  val SpikedBall = Trap("Spiked Ball", 70, 0.7, Ceiling, Sadistic, 90, Set(Roll, MoveToWall, Enveloping))
  val Springboard = Trap("Springboard", 5, 0.7, Floor, Elaborate, 50, Set(Move3))
  val StickyArrow = Trap("Sticky Arrow", 3, 0.7, Wall, Humiliating, 70, Set(Projectile, MoveToWall))
  val StrayTrapDog = Trap("Stray Trap Dog", 30, 0.8, Floor, Humiliating, 60, Set(Move3))
  val Suezo = Trap("Suezo", 70, 1.0, Ceiling, Humiliating, 50, Set(Roll, Move5, Explode))
  val SuperSpringboard = Trap("Super Springboard", 10, 0.8, Floor, Elaborate, 55, Set(Move6))
  val SuspendedCeiling = Trap("Suspended Ceiling", 45, 1.2, Ceiling, Humiliating, 60, Set(HitsNear, StageHit2))
  val SwingingAnchor = Trap("Swinging Anchor", 35, 0.6, Ceiling, Sadistic, 80, Set(Enveloping))
  val SwingingAxe = Trap("Swinging Axe", 45, 0.9, Ceiling, Sadistic, 60, Set(Move3))
  val SwingingHammer = Trap("Swinging Hammer", 20, 0.9, Ceiling, Elaborate, 55, Set(Move4))
  ...
  val TortureWheel = Trap("TortureW heel", 30, 0.8, Ceiling, Sadistic, 70, Set(Enveloping))
  val TrapDog = Trap("Trap Dog", 30, 0.7, Floor, Sadistic, 50, Set(Bind))
  val VacuumFloor = Trap("Vacuum Floor", 1, 0.5, Floor, Elaborate, 50, Set(Bind))
